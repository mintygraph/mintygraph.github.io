...
$(document).ready(function(){
    ...
    defaultSize = parseInt($("#hiddenFont").css("font-size"),10);
    $(".content").css("font-size", defaultSize);
    $("#hiddenResizer").css("font-size", defaultSize);
    $("#generateBtn").click(function(){
        ...
        $("#generateBtn").css("background-color",newColor);
        var jobEntry = jobs[Math.floor(Math.random()*jobs.length)];
        $("#whatever").text(jobEntry.concat("s"));
        $("#hiddenText").text(jobEntry.concat("s"));
        if($(".jumbotron").width() > $("#hiddenResizer").width()){
            $(".content").css("font-size", defaultSize);
            $("#hiddenResizer").css("font-size", defaultSize);
        }
        else if($(".content").width() < $("#hiddenResizer").width()){
            size = parseInt($("#hiddenResizer").css("font-size"),10);
            while($(".content").width() < $("#hiddenResizer").width()){
                size= size-2;
                $("#hiddenResizer").css("font-size", size);
            }
            $(".content").css("font-size", size);
            $("#hiddenResizer").css("font-size", defaultSize);
        } 
        $('#tweet-btn').attr('href', 'https://twitter.com/intent/tweet?text='+"Tinder but for "+jobEntry+"s").attr('target', '_blank');
 $('#tumblr-btn').attr('href', 'ttps://www.tumblr.com/widgets/share/tool?posttype=quote&caption=Tinder for X&content='+"Tinder but for "+jobEntry+"s&canonicalUrl=https%3A%2F%2Fwww.tumblr.com%2Fbuttons&shareSource=tumblr_share_button ").attr('target', '_blank');
...
function getRandomColor() {
    ...
    var newSat = Math.floor(Math.random()*100);
    var newLum = Math.floor(Math.random() * 75);
    newColor = "hsl(";
    newColor = newColor+newHue+","+newSat+"%,"+newLum+"%)";
    console.log(newColor);
    return newColor;
}

var jobs = ["accountant","actor","actuary",	"adhesive bonding machine tender","adjudicator","administrative assistant",
            "administrative services manager","adult education teacher","advertising manager","advertising sales agent",
            "aerobics instructor","aerospace engineer","aerospace engineering technician","agent","agricultural engineer","agricultural equipment operator","agricultural grader","agricultural inspector","agricultural manager","agricultural sciences teacher","agricultural sorter",
